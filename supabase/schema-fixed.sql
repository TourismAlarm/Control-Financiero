-- PASO 1: Modificar la tabla users para usar TEXT en google_id
-- Primero eliminamos las constraints existentes si hay datos
ALTER TABLE users ALTER COLUMN google_id TYPE TEXT;

-- PASO 2: Tabla para datos financieros del usuario
...
-- PASO 3: Tabla para historial mensual
